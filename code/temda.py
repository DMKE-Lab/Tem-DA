...
from temda_layer import TemDAGraphAttentionLayer, HighwayLayer
from temda_func import update_labeled_alignment_x, update_labeled_alignment_y
...
class TemDA:
    ...
    def define_model(self):
        ...
        for i in range(layer_num):
            ...
            if i < layer_num - 1:
                gat_layer = TemDAGraphAttentionLayer(input_dim=self.layer_dims[i],
                                                      output_dim=self.layer_dims[i + 1],
                                                      adj=[self.adj_mat[1]],
